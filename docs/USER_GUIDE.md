...
Version 0.4.0 · Developed by M Intergraph Systems Pvt. Ltd. (MINT)
...
1. **Download.** Copy the installer file — **`FinTrace NCRP Setup 0.4.0.exe`** —
...
- **Software:** FinTrace NCRP, Version 0.4.0

When you contact support, please include:

- the **version** shown at the bottom of the left menu (v0.4.0),
